...
from .models import SGV, DeviceStatus, ProfileDefinitionSet, ServerStatus, Treatment
...
class Api:
    ...
    def request_headers(self, api_secret: str | None = None):  # noqa: D102
    ...
    async def get_sgvs(self, params={}) -> list[SGV]:
    ...
    async def get_treatments(self, params={}) -> list[Treatment]:
        """Fetch treatments.
